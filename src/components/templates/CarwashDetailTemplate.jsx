...
const CarwashDetailTemplate = (
  { 
    ...
    selectedPoints = ["하부세차", "100% 수돗물", "개러지형 독립공간", 
    "야간 조명", "휴게실", "에어컨", "발수코팅건"],
  ...
  return (
    <div className='w-auto h-auto overflow-y-auto'>
      ...
      <div className='flex flex-row justify-between mx-4 my-2'>
        ...
        {/* 예약 베이 수 */}
        <div className='flex flex-col'>
          <div className='text-3xl font-bold text-center text-sky-500'>{bayCount}</div>
          <div className='text-sm font-semibold'>예약베이</div>
        </div>
      </div>
      {/* 영업 정보 */}
      <div className='flex flex-col gap-4 mx-4 mt-4'>
        <StoreInfo weekhour={weekhour} weekendhour={weekendhour} tel={tel} address={address} />
